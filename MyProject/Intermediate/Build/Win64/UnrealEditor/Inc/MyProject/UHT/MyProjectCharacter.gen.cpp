...
// ********** Begin Class AMyProjectCharacter Function DoAim ***************************************
struct Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics
{
	struct MyProjectCharacter_eventDoAim_Parms
	{
		float Yaw;
		float Pitch;
	};
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::NewProp_Yaw = { "Yaw", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MyProjectCharacter_eventDoAim_Parms, Yaw), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::NewProp_Pitch = { "Pitch", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MyProjectCharacter_eventDoAim_Parms, Pitch), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::NewProp_Yaw,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::NewProp_Pitch,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AMyProjectCharacter, nullptr, "DoAim", Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::MyProjectCharacter_eventDoAim_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::MyProjectCharacter_eventDoAim_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_AMyProjectCharacter_DoAim()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AMyProjectCharacter_DoAim_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(AMyProjectCharacter::execDoAim)
{
...
// ********** End Class AMyProjectCharacter Function DoAim *****************************************
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMyProjectCharacter_DoJumpEnd_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AMyProjectCharacter, nullptr, "DoJumpEnd", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyProjectCharacter_DoJumpEnd_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMyProjectCharacter_DoJumpEnd_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMyProjectCharacter_DoJumpStart_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AMyProjectCharacter, nullptr, "DoJumpStart", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyProjectCharacter_DoJumpStart_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMyProjectCharacter_DoJumpStart_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AMyProjectCharacter_DoMove_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_AMyProjectCharacter, nullptr, "DoMove", Z_Construct_UFunction_AMyProjectCharacter_DoMove_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMyProjectCharacter_DoMove_Statics::PropPointers), sizeof(Z_Construct_UFunction_AMyProjectCharacter_DoMove_Statics::MyProjectCharacter_eventDoMove_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AMyProjectCharacter_DoMove_Statics::Function_MetaDataParams), Z_Construct_UFunction_AMyProjectCharacter_DoMove_Statics::Function_MetaDataParams)},  };
...
void AMyProjectCharacter::StaticRegisterNativesAMyProjectCharacter()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "DoAim", &AMyProjectCharacter::execDoAim },
		{ "DoJumpEnd", &AMyProjectCharacter::execDoJumpEnd },
		{ "DoJumpStart", &AMyProjectCharacter::execDoJumpStart },
		{ "DoMove", &AMyProjectCharacter::execDoMove },
	};
...
struct Z_Construct_UClass_AMyProjectCharacter_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AMyProjectCharacter_DoAim, "DoAim" }, // 2534180270
		{ &Z_Construct_UFunction_AMyProjectCharacter_DoJumpEnd, "DoJumpEnd" }, // 2560738901
		{ &Z_Construct_UFunction_AMyProjectCharacter_DoJumpStart, "DoJumpStart" }, // 2348090415
		{ &Z_Construct_UFunction_AMyProjectCharacter_DoMove, "DoMove" }, // 1213531436
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMyProjectCharacter_Statics::NewProp_FirstPersonMesh = { "FirstPersonMesh", nullptr, (EPropertyFlags)0x00400000000a001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMyProjectCharacter, FirstPersonMesh), Z_Construct_UClass_USkeletalMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FirstPersonMesh_MetaData), NewProp_FirstPersonMesh_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMyProjectCharacter_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMyProjectCharacter_Statics::NewProp_FirstPersonMesh,
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_Student_Desktop_Cita417Assignment3_MyProject_Source_MyProject_MyProjectCharacter_h__Script_MyProject_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMyProjectCharacter, AMyProjectCharacter::StaticClass, TEXT("AMyProjectCharacter"), &Z_Registration_Info_UClass_AMyProjectCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyProjectCharacter), 3381358922U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Student_Desktop_Cita417Assignment3_MyProject_Source_MyProject_MyProjectCharacter_h__Script_MyProject_1281022813(TEXT("/Script/MyProject"),
	Z_CompiledInDeferFile_FID_Users_Student_Desktop_Cita417Assignment3_MyProject_Source_MyProject_MyProjectCharacter_h__Script_MyProject_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Student_Desktop_Cita417Assignment3_MyProject_Source_MyProject_MyProjectCharacter_h__Script_MyProject_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
